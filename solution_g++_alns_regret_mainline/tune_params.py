...
DEFAULT_CONFIG = {
    ...
    "tetris_weight": 0.0,
    "tetris_tie_epsilon": 0.0,
    "late_acceptance_window": 0,
    "late_acceptance_margin": 0.0,
    "tabu_tenure": 0,
    "tabu_block_tenure": 0,
    "small_window_repair_rounds": 20,
    "small_window_repair_width": 0,
    "small_window_repair_cap": 64,
    "regret_repair_enabled": 0,
    "regret_repair_k": 0,
    "regret_repair_weight": 0.0,
    "regret_repair_candidate_limit": 0,
    "regret_repair_scope": 0,
    "regret_repair_min_block": 0,
    "regret_repair_max_block": 0,
}
...
FLOAT_RANGES = {
    ...
    "tetris_weight": (0.0, 1.80),
    "tetris_tie_epsilon": (0.0, 10.0),
    "late_acceptance_margin": (0.0, 0.05),
    "regret_repair_weight": (0.0, 4.0),
}

INT_RANGES = {
    "repair_rounds": (20, 95),
    "candidate_limit": (0, 50),
    "late_acceptance_window": (0, 500),
    "tabu_tenure": (0, 20),
    "tabu_block_tenure": (0, 25),
    "small_window_repair_rounds": (0, 24),
    "small_window_repair_width": (0, 10000),
    "small_window_repair_cap": (32, 96),
    "regret_repair_enabled": (0, 1),
    "regret_repair_k": (0, 3),
    "regret_repair_candidate_limit": (0, 48),
    "regret_repair_scope": (0, 2),
    "regret_repair_min_block": (0, 32),
    "regret_repair_max_block": (0, 96),
}
...
def build_solution(solution_dir):
    result = subprocess.run(["bash", "build.sh"], cwd=solution_dir, text=True)
...
def main():
    ...
    parser.add_argument("--config-dir", type=Path, default=Path("solution_g++_alns_regret_mainline/experiments"))
    ...
    parser.add_argument("--top-dir", type=Path, default=Path("solution_g++_alns_regret_mainline/top_configs"))
